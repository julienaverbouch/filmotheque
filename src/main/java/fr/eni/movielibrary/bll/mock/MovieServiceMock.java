...
public class MovieServiceMock implements MovieService {
	...
	private static List<Opinion> lstOpinion = new ArrayList<Opinion>();
	...
	public MovieServiceMock() {
		...
		Opinion opinionJurassicPark1 = new Opinion(1, 15, "super film, j'ai adoré");
		Opinion opinionJurassicPark2 = new Opinion(1, 15, "BOF BOF");
		lstOpinion.add(opinionJurassicPark1);
		lstOpinion.add(opinionJurassicPark2);
